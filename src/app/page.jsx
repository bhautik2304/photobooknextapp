            ...
            <div className="row pb-md-3 pb-lg-4 mb-2 mb-lg-3">
              ...
              <div className="col-md-5 d-flex align-items-center mb-md-0">
                <div>
                  <div className="position-relative" style={{ maxWidth: '416px' }}>
                    <img className="d-block position-relative zindex-2" src="/assets/img/logo.png" alt="Nicolas Black" />
                    <div className="position-absolute start-0 bottom-0 w-100" style={{ height: '85.4%', borderRadius: '2.25rem 8rem 2.25rem 2.25rem' }}></div>
                  </div>
                  <div className="text-center text-md-start pt-3 mt-3">
                    ...
                    <div className="position-relative pt-4" style={{ maxWidth: '500px' }}>
                      ...
                      <p className="fs-xl position-relative zindex-2 mb-0">The main task of our organization is <strong>to assess the state of your enterprise now and how you can achieve your goals.</strong> Self-assessment of current activities and review of processes formulate decisions to achieve the desired outcome.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-7 col-lg-6 col-xxl-5 offset-lg-1 offset-xxl-2">
                <div className="ps-md-4 ps-lg-0">
                  <div className="position-relative d-flex justify-content-end" data-aos="fade-left" data-aos-easing="ease-out-back">
                    ...
                    <div className="card border-0 ps-3" style={{ width: 'calc(100% - 1.75rem)' }}>
                      <div className="card-body ps-4">
                        <h3 className="h5 card-title pb-2 mb-1">Create an account with us</h3>
                        <p className="card-text">Find aute irure dolor in reprehenderi voluptate velit esse cillum dolore eu fugiat nulla pariatur am luctus.</p>
                      </div>
                    </div>
                  </div>
                  <div className="position-relative d-flex justify-content-end" data-aos="fade-left" data-aos-easing="ease-out-back" data-aos-delay="250">
                    ...
                    <div className="card border-0 ps-3" style={{ width: 'calc(100% - 1.75rem)' }}>
                      <div className="card-body ps-4">
                        <h3 className="h5 card-title pb-2 mb-1">Login to your dashboard</h3>
                        <p className="card-text">Risus quam quis at euismod vitae dui elementu eu in diam malesuada mattis ut urna integer erat nisi nibh.</p>
                      </div>
                    </div>
                  </div>
                  <div className="position-relative d-flex justify-content-end" data-aos="fade-left" data-aos-easing="ease-out-back" data-aos-delay="500">
                    ...
                    <div className="card border-0 ps-3" style={{ width: 'calc(100% - 1.75rem)' }}>
                      <div className="card-body ps-4">
                        <h3 className="h5 card-title pb-2 mb-1">Select product and start order journey</h3>
                        <p className="card-text">A sagittis morbi massa venenatis, egestas viverra ac elit nibh tellus nisi in nec tellus mauris feugiat gravida.</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="accordion" id="faq">
                <div className="accordion-item bg-secondary">
                  <h3 className="accordion-header" id="headingOne">
                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#questionOne" aria-expanded="true" aria-controls="questionOne">Q. How do I order an album online?</button>
                  </h3>
                ...
                <div className="accordion-item bg-secondary">
                  <h3 className="accordion-header" id="headingTwo">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#questionTwo" aria-expanded="false" aria-controls="questionTwo">Q. What paper surfaces are available at the lab?</button>
                  </h3>
                ...
                <div className="accordion-item bg-secondary">
                  <h3 className="accordion-header" id="headingThree">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#questionThree" aria-expanded="false" aria-controls="questionThree">Q. What is the turn around time for an album?</button>
                  </h3>
