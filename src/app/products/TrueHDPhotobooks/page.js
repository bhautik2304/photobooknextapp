                    ...
                    <div class="row d-lg-flex align-items-center pt-3 pb-xxl-5">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 order-lg-1 text-center text-lg-start pe-lg-4 py-4 py-md-5">
                            ...
                            <p class="fs-lg mx-auto mx-lg-0 mb-0" style={{ maxWidth: "530px" }}>Introducing True HD Photo Books: Where True Vibrancy Meets Timeless Memories <br />
                                True HD Photo Books are more than just albums; they're vibrant, immersive journeys through your most cherished moments. Crafted with precision and passion, True HD stands as a testament to the power of preserving memories with unparalleled vibrancy and authenticity.</p>
                        </div>
                    </div>
                ...
                <div class="row py-sm-3 py-md-4 py-lg-5">
                    <div class="col-md-9 offset-lg-1">
                        <div class="ps-md-4 ps-lg-0">
                            ...
                            <p class="fs-lg mb-0">True HD Photo Books are perfect for capturing and commemorating all of life's special moments. Whether it's a wedding, a birthday, a graduation, or a family vacation, True HD offers a versatile and elegant way to preserve your memories for years to come. With True Hd, every occasion becomes an opportunity to create something truly extraordinary.
                            </p>
