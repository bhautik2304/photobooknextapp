                ...
                <div class="container position-relative z-2 py-5 pb-lg-0">
                    ...
                    <div class="d-lg-flex align-items-center pt-3 pb-xxl-5">
                        ...
                        <div class="order-lg-1 text-center text-lg-start pe-lg-4 py-4 py-md-5">
                            ...
                            <p class="fs-lg mx-auto mx-lg-0 mb-0" style={{ maxWidth: "530px" }}>Introducing TruVib Photobooks: Where True Vibrancy Meets Timeless Memories <br />
                                TruVib Photobooks are more than just albums; they're vibrant, immersive journeys through your most cherished moments. Crafted with precision and passion, TruVib stands as a testament to the power of preserving memories with unparalleled vibrancy and authenticity.</p>
                        </div>
                    </div>
                ...
                <div class="row py-sm-3 py-md-4 py-lg-5">
                    <div class="col-md-9 offset-lg-1">
                        <div class="ps-md-4 ps-lg-0">
                            ...
                            <p class="fs-lg">TruVib isn't just about printing photos; it's about capturing the true essence and vibrancy of your memories. Our advanced printing technology ensures that every color pops, every detail shines, and every moment feels as vivid and alive as the day it was captured. With TruVib, your memories are more than just images – they're true reflections of the moments that matter most.</p>
                            <h3 class="h3 pt-3 pt-sm-4 pt-xl-5 pb-2">Unmatched Quality and Craftsmanship</h3>
                            <p class="fs-lg">At TruVib, we believe that your memories deserve the very best. That's why we use only the highest quality materials and the most advanced printing techniques to create photobooks that are as stunning as they are durable. From premium paper stock to luxurious cover materials, every aspect of a TruVib Photobook is meticulously crafted to ensure that your memories stand the test of time.
                            </p>
                            <h3 class="h3 pt-3 pt-sm-4 pt-xl-5 pb-2">Personalized to Perfection
                            </h3>
                            <p class="fs-lg mb-0">Your memories are unique, and your photobook should be too. With TruVib, you have the freedom to customize every aspect of your photobook, from the layout and design to the cover material and finishing touches. Whether you prefer a sleek and modern aesthetic or a classic and timeless look, TruVib gives you the tools to create a photobook that perfectly reflects your style and personality.
                            </p>
                            <h3 class="h3 pt-3 pt-sm-4 pt-xl-5 pb-2">Perfect for Every Occasion
                            </h3>
                            <p class="fs-lg mb-0">TruVib Photobooks are perfect for capturing and commemorating all of life's special moments. Whether it's a wedding, a birthday, a graduation, or a family vacation, TruVib offers a versatile and elegant way to preserve your memories for years to come. With TruVib, every occasion becomes an opportunity to create something truly extraordinary.
                            </p>
                            <h3 class="h3 pt-3 pt-sm-4 pt-xl-5 pb-2">Experience True Vibrancy with TruVib
                            </h3>
                            <p class="fs-lg mb-0">Your memories are vibrant, dynamic, and full of life – shouldn't your photobooks be too? Experience the true vibrancy of your memories with TruVib Photobooks and embark on a journey through your most cherished moments like never before. Because when it comes to preserving memories, nothing captures the true essence of life quite like TruVib.
                            </p>
                        </div>
                    </div>
                </div>
