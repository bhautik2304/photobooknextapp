      ...
      <section class="">
        <div class="container pt-5 pb-sm-3 mt-5 mb-2 mb-md-3 mb-lg-4 mb-xxl-5">
          ...
          <section style={{
            ...
            <div class="col-md-5 col-xl-4 offset-xxl-1 order-md-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="180" data-disable-parallax-down="md">
              <div class="me-md-4 me-lg-5 me-xxl-0" style={{ maxWidth: 400 }}>
                ...
                <h2 class="mb-lg-4">
                  <Link href={`${appRoutes.Products}/TrueVibPhotobooks`}>True Hd Photobooks</Link>
                </h2>
                <p class="mb-0 mb-md-1 mb-lg-3">True Hd Photobooks are more than just albums; they're vibrant, immersive journeys through your most cherished moments. Crafted with precision and passion.</p>
          ...
          <section style={{
            ...
            <div class="col-md-7 order-md-2 mb-4 mb-md-0">
              <Link href={`${appRoutes.Products}/PresentationBoxesAndBags`}>
            ...
            <div class="col-md-5 col-xl-4 offset-xxl-1 order-md-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="180" data-disable-parallax-down="md">
              <div class="me-md-4 me-lg-5 me-xxl-0" style={{ maxWidth: 400 }}>
                {/* <div class="text-body-secondary mb-2">Branding</div> */}
                <h2 class="mb-lg-4">
                  <Link href={`${appRoutes.Products}/PresentationBoxesAndBags`}>Presentation Boxes & Bags</Link>
                </h2>
                <p class="mb-0 mb-md-1 mb-lg-3">True Hd Photobooks are more than just albums; they're vibrant, immersive journeys through your most cherished moments. Crafted with precision and passion.</p>
                <Link class="btn btn-sm btn-outline-dark rounded-pill" href={`${appRoutes.Products}/PresentationBoxesAndBags`}>Get More Details</Link>
