        ...
        <div>
            {!status ?
                <>
                    ...
                    <div classNameName="row">
                        <div classNameName="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="password-toggle mb-2">
                                <input className="form-control form-control-lg" onChange={(e) => setData({ ...data, password: e.target.value })} type={show ? "text" : "password"} placeholder="Password *" required />
                        ...
                        <div classNameName="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-1 row-cols-lg-2">
                                <div className="col mb-2">
                                    ...
                                    <input className="form-control form-control-lg" onChange={(e) => setData({ ...data, city: e.target.value })} type="text" placeholder="City *" required />
                                </div>
                                <div className="col mb-2">
                    ...
                    <button className="btn btn-md btn-primary w-100 my-4 pro" onClick={() => submitData()} style={{ borderRadius: '5px !important' }}>Sign up</button>
                </>
                :
                <>
                    <div classNameName="row">
                        ...
                        <center>
                            <div class="alert alert-primary" role="alert">
                                You have successfully registered and your profile is under review , please wait for approval
                            </div>
                        </center>
                        <center>
                            <button className="btn btn-md btn-primary w-100 my-4 pro" variant="contained" onClick={() => {
                                router.replace(appRoutes.Login)
                            }} size='medium' >Go to login</button>
                        </center>
                    </div>
                </>
            }
