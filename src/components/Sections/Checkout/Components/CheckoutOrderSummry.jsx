                                        ...
                                        {Number(orderData?.discount) != 0 ? (
                                            <>
                                                <tr>
                                                    ...
                                                    <td class="border-0 text-end py-1 pe-0 ps-3 ps-sm-4">
                                                        <div class="fs-sm fw-medium text-danger mb-2">{`- ${user?.zone?.currency_sign
                                                            } ${Math.round(
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-0 text-end py-1 pe-0 ps-3 ps-sm-4">
                                                        <div class="fs-sm fw-medium text-success mb-2">{`${user?.zone?.currency_sign
                                                            } ${Math.round(
                                        ...
                                        {orderData?.pritnig_price_type == "design_print_bind" ? (
                                            <>
                                                <tr>
                                                    ...
                                                    <td class="border-0 text-end py-1 pe-0 ps-3 ps-sm-4">
                                                        <div class="fs-sm fw-medium mb-2">{`${user?.zone?.currency_sign
