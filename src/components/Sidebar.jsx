      ...
      <aside className="col-lg-3 p-5">
        <div className="position-lg-sticky top-1">
          ...
          <div className="offcanvas-lg offcanvas-start" id="sidebarAccount">
            <button
              className="btn-close position-absolute top-0 end-0 me-3 d-lg-none"
              type="button"
            ...
            <div className="offcanvas-body">
                ...
                {path == appRoutes.userProfile ? (
                  <>
                    <a
                      ...
                      style={{ color: "#64748b" }}
                    >
                      <i className="ai-user-check fs-5 opacity-60 me-2"></i>Your
                      Profile
                    </a>
                  </>
                ) : (
                ...
                {path == appRoutes.userProfileOrders ? (
                  <>
                    <a
                      ...
                      style={{ color: "#64748b" }}
                    >
                      <i className="ai-cart fs-5 opacity-60 me-2"></i>Your
                      Orders
                    </a>
                  </>
                ) : (
              ...
              <nav className="nav flex-column">
                <a className="nav-link py-2 px-0" style={{ color: "#64748b" }}>
                  <i className="ai-logout fs-5 opacity-60 me-2"></i>Sign Out
                </a>
              </nav>
            </div>
          </div>
...
function MyDropzone({ user }) {
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    axios
      .post(apiRoutes.updateAvtar, formData)
      .then((e) => {
        console.log(e);
        dispatch(fetchUsers());
      })
