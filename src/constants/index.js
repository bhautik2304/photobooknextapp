...
const dserverDomain = "http://192.168.1.39:8000/api";
...
export const apiRoutes = {
  ...
  payment:{
    pamymentCreat:dserverDomain + "/create-payment-intent",
    pamymentCancel:dserverDomain + "/cancel-payment-intent",
    pamymentStatusUpdate:dserverDomain + "/cancel-payment-intent",
  }
};
